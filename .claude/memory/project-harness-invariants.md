...
absolute path (`/wiki/economics/defi/markets/amm`), not a Hugo `ref`/`relref` shortcode. Hugo
renders a link to a nonexistent page without warning, and the build stays green.
Six links to `/wiki/economics/defi/chainlink-automation` had been 404ing in production
