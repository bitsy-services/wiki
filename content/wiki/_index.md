...
Seven sections so far, ordered here as they appear in the sidebar:

- [Economics](/wiki/economics) — how value gets created, priced, and moved. Almost all of it currently sits under [finance](/wiki/economics/finance) and, beneath that, [DeFi](/wiki/economics/finance/defi): the largest section of the wiki, running from what a [blockchain](/wiki/economics/finance/defi/blockchain) is up through the [options](/wiki/economics/finance/defi/options) machinery built at bitsy.services. [Regulation](/wiki/economics/finance/regulation) sits alongside it — the [Bank Secrecy Act](/wiki/economics/finance/regulation/bank-secrecy-act) and the [anti-money-laundering](/wiki/economics/finance/regulation/anti-money-laundering) regime that decides what any of it is allowed to do — and [fraud](/wiki/economics/finance/fraud) covers what happens where the rules do not reach, one page per mechanism from [rug pulls](/wiki/economics/finance/fraud/rug-pull) to [pig butchering](/wiki/economics/finance/fraud/pig-butchering).
...
Pages link to each other heavily on purpose. Following the links tends to be a better way through the material than reading a section top to bottom. A subject that fits none of the seven gets an eighth.
