...
[Anthropic](/wiki/ai/models/anthropic) published the specification in November 2024 and open-sourced it; it has since been implemented by competing products, which makes it the one piece of that lab's work to have spread past it.
