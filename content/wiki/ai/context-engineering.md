...
1. **Attention dilutes.** Transformer attention is spread across all tokens. Doubling the irrelevant context does not leave the signal untouched — it lowers the relative weight the model can place on the tokens that matter.
