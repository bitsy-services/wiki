...
Depends on [backprop through one weight](/wiki/ai/llm/backprop-one-weight). Leads to [the KV cache](/wiki/ai/llm/kv-cache) and [positional encoding and RoPE](/wiki/ai/llm/positional-encoding-and-rope).
