...
For a concrete instance — why keeping `CLAUDE.md` and tool schemas stable at the front of the window makes a session cheap — see the section's running example, [Claude Code: writing a page for this wiki](/wiki/ai/context-engineering/claude-code).
