...
- **Distributed ledgers** — IOTA's [Tangle](/wiki/economics/defi/iota/tangle) replaced the linear chain with a transaction DAG; modern BFT (Byzantine fault tolerant) consensus protocols such as Mysticeti are also DAG-structured.
