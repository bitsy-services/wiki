...
- **Content addressing** — Merkle DAGs underpin [IPFS](/wiki/cs/ipfs), where [UnixFS](/wiki/cs/ipfs/unixfs) is the layout that turns a file into one, and Git's object store; a [blockchain](/wiki/economics/defi/blockchain) is the degenerate linear case.
- **Distributed ledgers** — IOTA's [Tangle](/wiki/economics/defi/chains/iota/tangle) replaced the linear chain with a transaction DAG; modern BFT (Byzantine fault tolerant) consensus protocols such as Mysticeti are also DAG-structured.
