...
Real estate transactions are slow, expensive, and burdened with intermediaries -- title companies, escrow agents, lawyers, and brokers each take a cut. [Smart contracts](/wiki/defi/smart-contract) on a [blockchain](/wiki/defi/blockchain) can automate much of this pipeline, cutting costs and reducing the surface area for disputes.

## Tokenized Ownership

Tokenizing real estate means representing ownership shares as [ERC-20](/wiki/defi/ethereum/erc-20) tokens on [Ethereum](/wiki/defi/ethereum/) or another programmable chain. This enables two models that are difficult or impossible with traditional title systems:
