...
In the blockchain world, TEEs underpin [confidential smart contracts](/wiki/defi/sapphire) — most prominently [Oasis Sapphire](/wiki/defi/sapphire), the confidential [EVM](/wiki/defi/ethereum/) — as well as confidential off-chain compute, trusted oracles, and key-management services.
