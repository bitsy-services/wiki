...
- **Better suited to volatile markets** -- [volatility](/wiki/defi/volatility) increases the chance of extreme moves; a hard loss cap prevents catastrophic drawdowns.
...
In traditional markets, risk definition depends on the broker holding sufficient margin and the clearinghouse guaranteeing settlement. In DeFi, the [smart contract](/wiki/defi/smart-contract) itself is the enforcement mechanism:
...
This model eliminates the counterparty and settlement risks present in traditional options but introduces [smart-contract](/wiki/defi/smart-contract) risk -- a bug in the contract can circumvent the intended risk boundaries entirely.
