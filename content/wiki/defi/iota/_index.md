...
| [IOTA Rebased](/wiki/defi/iota/iota-rebased) (May 2025+) | Object ledger on the Move VM | ~0.005 IOTA per tx, burned | dPoS, permissionless staked validators, no Coordinator | Native Move on L1; [IOTA EVM](/wiki/defi/iota/iota-evm) still runs as L2 |
...
- **MEV posture** — the DAG-based consensus pipeline (now Starfish) limits some classes of [maximal extractable value](/wiki/defi/maximal-extractable-value), though this should be treated as a design goal rather than a guarantee.
...
- **Starfish consensus (May 2026)** — mainnet protocol v24 swapped Mysticeti for IOTA's own [Starfish](https://blog.iota.org/why-starfish-matters/), an uncertified-DAG BFT protocol with rigorous liveness proofs and better tail latency under adverse conditions. Detail on [the Rebased page](/wiki/defi/iota/iota-rebased#consensus-mysticeti-to-starfish).
