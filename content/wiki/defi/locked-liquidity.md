...
Locked liquidity is an [AMM](/wiki/defi/amm) position whose principal can never be withdrawn — not by its creator, not by anyone. It is the difference between "the team *promises* not to pull the pool" and "the pull function does not exist." A [liquidity floor](/wiki/defi/liquidity-floor) or a peg is only as credible as the guarantee that the backing stays put; locked liquidity is that guarantee made structural.
...
- A [liquidity floor](/wiki/defi/liquidity-floor) cannot be relocated lower if the position cannot be moved.
- [Full-reserve backing](/wiki/defi/full-reserve-backing) cannot be quietly drained if there is no drain.
- A [par token](/wiki/defi/par-token)'s reserves are credible precisely because the position holding them has no decrease path.
