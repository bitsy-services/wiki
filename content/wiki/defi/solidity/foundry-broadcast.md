...
After simulation succeeds, Foundry replays the recorded state-changing operations as individual transactions, each with an incrementing [nonce](/wiki/defi/nonce). The transactions are submitted in the order they appeared in the script.
