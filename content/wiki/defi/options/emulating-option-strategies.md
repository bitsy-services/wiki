...
**Smart-contract risk** -- every leg of the strategy is a [smart-contract](/wiki/defi/smart-contract) interaction. A bug in the AMM, vault, or perp protocol can cause losses beyond the strategy's intended risk profile.

**Liquidity risk** -- exiting a concentrated LP position in a thin [pool](/wiki/defi/liquidity-pool) may incur significant slippage, especially during volatile markets.
