...
- **Butterfly spread** -- three strikes, same option type. Buy the wings, sell the body (or vice versa). Profits from low [volatility](/wiki/defi/volatility) when the underlying expires near the middle strike.
...
- **Settlement** -- DeFi options typically settle in the underlying or a stablecoin, with [smart contracts](/wiki/defi/smart-contract) handling exercise automatically at expiration.
