...
**Option type** is the most basic classification of an options contract: it is either a [call option](/wiki/defi/options/call-option) or a [put option](/wiki/defi/options/put-option). Every other property of an option -- [strike price](/wiki/defi/options/strike-price), expiry, the [Greeks](/wiki/defi/options/option-greeks) -- builds on top of this distinction.
...
- **Exotic** -- any non-standard exercise rule. Includes barrier options (activate or deactivate at a price threshold), Asian options (payoff based on an average price), and [perpetual options](/wiki/defi/options/perpetual-option) (no expiry at all).
...
- **[Vertical spread](/wiki/defi/options/vertical-spread)** -- buy and sell options of the same type at different strikes to cap both risk and reward.
...
The [option spread](/wiki/defi/options/option-spread) page covers multi-leg structures in more detail.
