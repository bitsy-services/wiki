...
Staking is the act of locking cryptocurrency in a protocol to earn rewards. The term covers two distinct mechanisms: **network staking**, where locked tokens secure a blockchain's consensus, and **DeFi staking**, where tokens are deposited into [smart contracts](/wiki/defi/smart-contract) to earn yield from protocol activity.
...
1. A validator deposits the required minimum (32 ETH on [Ethereum](/wiki/defi/ethereum/), for example).
...
- **[Liquidity pool](/wiki/defi/liquidity-pool) deposits** — providing assets to an [AMM](/wiki/defi/amm) [DEX](/wiki/defi/dex) earns trading fees and sometimes additional token incentives. This is sometimes called [yield farming](/wiki/defi/yield-farming) when the primary goal is earning governance token rewards.
...
| **[Impermanent loss](/wiki/defi/impermanent-loss)** | Applies when staking in AMM liquidity pools. The pool rebalances against you as prices move. |
