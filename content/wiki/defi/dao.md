...
**Token-based** -- Anyone who holds the governance token can vote. Tokens are freely tradable on [decentralized exchanges](/wiki/defi/dex), making membership permissionless. Voting power scales with token holdings. [Uniswap](/wiki/defi/uniswap) and MakerDAO use this model.
...
**Smart contract vulnerabilities** -- A bug in the governance contract can be catastrophic. The 2016 DAO hack exploited a reentrancy flaw and drained $50 million in [Ether](/wiki/defi/ethereum/), ultimately leading to Ethereum's contentious hard fork.
