...
A bull bet is a tokenized, on-chain derivative that packages a [bull call spread](/wiki/defi/bull-call-spread) into a single mintable asset. Instead of separately buying and selling [call options](/wiki/defi/call-option) at different [strike prices](/wiki/defi/strike-price), the bull bet wraps both legs into one [smart contract](/wiki/defi/smart-contract) interaction -- producing a tradeable token that represents the entire position.

Bull bets are a [risk-defined strategy](/wiki/defi/risk-defined-strategy): both the maximum gain and maximum loss are known at the time of purchase.

## Structure

A bull bet is economically equivalent to a [bull call spread](/wiki/defi/bull-call-spread) -- a [vertical spread](/wiki/defi/vertical-spread) constructed from two call options:
...
The bearish counterpart is the [bear bet](/wiki/defi/bear-bet), which tokenizes a [bear put spread](/wiki/defi/bear-put-spread).
