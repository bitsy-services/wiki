...
| **[Filecoin](/wiki/economics/defi/filecoin)** | Storage *deals* for a fixed term | Recurring, per deal | Cryptographic proofs for the deal's duration |
...
- **Permanent web hosting** -- static sites, [dapp](/wiki/economics/defi/dapp) frontends, and documentation deployed to the permaweb so they survive the company that built them.
