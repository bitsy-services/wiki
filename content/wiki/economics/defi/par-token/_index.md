...
1. [Single-tick liquidity](/wiki/economics/defi/markets/uniswap/single-tick-liquidity) — the entire supply seated in one [tick](/wiki/economics/defi/markets/uniswap/ticks) makes price a near-fixed rate inside a 1-bp corridor.
2. [Liquidity floor](/wiki/economics/defi/par-token/liquidity-floor) — no liquidity below par means sells cannot push price under 1:1.
3. [Oracle-free pricing](/wiki/economics/defi/oracles/oracle-free-pricing) — the corridor is a theorem about the position, not a feed; nothing to manipulate or stall.
4. [Locked liquidity](/wiki/economics/defi/par-token/locked-liquidity) — the position has no decrease path, so the backing can never be unwound.
5. [Full-reserve backing](/wiki/economics/defi/par-token/full-reserve-backing) — the reserve is the real originals accumulated 1:1 as buyers swap in.
6. [Permissionless token factory](/wiki/economics/defi/par-token/permissionless-token-factory) — anyone can instantiate one for any ERC-20, no gate.
...
- **Currency boards and bearer instruments** — the traditional-finance economic analog: full reserve, fixed rate, no discretion; the issuer earns the [float](/wiki/economics/defi/par-token/full-reserve-backing), not the principal — exactly a traveler's-cheque arrangement.
...
The pages beneath this one are four of the six techniques the composition above locks together. A [liquidity floor](/wiki/economics/defi/par-token/liquidity-floor) is a price nothing can trade below because there is nothing beneath it to sell into: the supply is seated in a single tick and no liquidity is ever placed under it. [Locked liquidity](/wiki/economics/defi/par-token/locked-liquidity) is what makes that absence permanent — the position has no withdrawal path, so the floor cannot be unwound or re-seated lower. [Full-reserve backing](/wiki/economics/defi/par-token/full-reserve-backing) is the guarantee on the other side: every unit issued is backed one-for-one by the reference asset, accumulated as buyers swap in. A [permissionless token factory](/wiki/economics/defi/par-token/permissionless-token-factory) is how one gets deployed without asking anyone. The two techniques not held here — [single-tick liquidity](/wiki/economics/defi/markets/uniswap/single-tick-liquidity) and [oracle-free pricing](/wiki/economics/defi/oracles/oracle-free-pricing) — live with the market and oracle mechanisms they belong to. The fee machinery that funds Bitsy's derivatives — the collateralization fee and the Fee Box — belongs to the [options](/wiki/economics/defi/options) system and lives there.
