...
By combining two LP positions at different ranges, a trader can approximate a [vertical spread](/wiki/economics/defi/options/vertical-spread):
...
[Perpetual options](/wiki/economics/defi/options/perpetual-option) (sometimes called "everlasting options") remove the expiry dimension entirely, offering continuously priced option exposure. Protocols that implement them can serve as building blocks for multi-leg strategies:
...
**No unlimited upside** -- a naked long [call option](/wiki/economics/defi/options/call-option) has theoretically unlimited profit potential. No LP position or capped binary bet can replicate this. Any LP-based or vault-based strategy is inherently a [risk-defined strategy](/wiki/economics/defi/options/risk-defined-strategy) with bounded payoffs.
