...
A call gives the right to *buy*; a [put option](/wiki/economics/defi/options/put-option) gives the right to *sell*. Calls profit from rising prices, puts from falling prices. The two are linked through put-call parity -- given the same strike and expiration, mispricing between the two creates an arbitrage opportunity.
...
- **[Implied volatility](/wiki/economics/defi/options/implied-volatility)** is often computed by the protocol's pricing engine rather than derived from an order book.
