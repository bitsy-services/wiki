...
- **[Strike price](/wiki/economics/defi/options/strike-price)** -- the price at which the holder can sell.
...
Note that moneyness for puts is the mirror of [call options](/wiki/economics/defi/options/call-option) -- a put is ITM when the spot price is *below* the strike.
...
A [call option](/wiki/economics/defi/options/call-option) gives the right to *buy*; a put gives the right to *sell*. The two are connected through put-call parity: for European-style options with the same strike and expiry, the prices of the call and put imply each other given the spot price and risk-free rate.
