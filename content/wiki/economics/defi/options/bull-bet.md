...
A bull bet is a tokenized, on-chain derivative that packages a [bull call spread](/wiki/economics/defi/options/bull-call-spread) into a single mintable asset. Instead of separately buying and selling [call options](/wiki/economics/defi/options/call-option) at different [strike prices](/wiki/economics/defi/options/strike-price), the bull bet wraps both legs into one [smart contract](/wiki/economics/defi/smart-contract) interaction -- producing a tradeable token that represents the entire position.

Bull bets are a [risk-defined strategy](/wiki/economics/defi/options/risk-defined-strategy): both the maximum gain and maximum loss are known at the time of purchase.

## Structure

A bull bet is economically equivalent to a [bull call spread](/wiki/economics/defi/options/bull-call-spread) -- a [vertical spread](/wiki/economics/defi/options/vertical-spread) constructed from two call options:
...
The bearish counterpart is the [bear bet](/wiki/economics/defi/options/bear-bet), which tokenizes a [bear put spread](/wiki/economics/defi/options/bear-put-spread).
