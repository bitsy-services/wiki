...
| Vega | ν | [Implied volatility](/wiki/economics/defi/options/implied-volatility) | Always positive | Always positive |
...
- A [call option](/wiki/economics/defi/options/call-option) with delta 0.60 gains $0.60 when the underlying rises $1.
- A [put option](/wiki/economics/defi/options/put-option) with delta -0.40 gains $0.40 when the underlying falls $1.
...
At-the-money (ATM) options have delta near ±0.50. As an option moves deeper ITM, delta approaches ±1; as it moves further [out-of-the-money](/wiki/economics/defi/options/strike-price) (OTM), delta approaches 0.
...
Vega measures the change in an option's price for a one-percentage-point change in [implied volatility](/wiki/economics/defi/options/implied-volatility).
...
An ETH [call option](/wiki/economics/defi/options/call-option) with a $2,000 [strike](/wiki/economics/defi/options/strike-price), 14 days to expiry, spot at $1,950:
