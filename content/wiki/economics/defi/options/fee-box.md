...
| `distributeFees(recipient, amount)` | Sends fees to a designated address -- treasury, [DAO](/wiki/economics/defi/smart-contract/dao), staking rewards, etc. |
...
In practice, the authorized distributor is typically a governance contract (a [DAO](/wiki/economics/defi/smart-contract/dao)) or a predefined payout schedule encoded in another smart contract.
...
- **Staking rewards.** Fees distribute to token holders who have [staked](/wiki/economics/defi/markets/staking) governance tokens, aligning protocol revenue with governance participation.
- **Automated payouts.** A [decentralized keeper](/wiki/economics/defi/oracles/decentralized-keeper) triggers periodic distribution calls on a schedule, removing the need for manual intervention.
...
For the full settlement flow and how the Fee Box fits into the contract architecture, see [CBSO Design](/wiki/economics/defi/options/cash-backed-synthetic-options-design).
