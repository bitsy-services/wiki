...
A **vertical spread** is an [option spread](/wiki/economics/defi/options/option-spread) built from two options of the same type -- both [calls](/wiki/economics/defi/options/call-option) or both [puts](/wiki/economics/defi/options/put-option) -- with the same expiration date but different [strike prices](/wiki/economics/defi/options/strike-price). The name comes from the options chain layout, where strike prices are listed vertically.
...
- **Debit spreads** pay upfront and receive value at expiration. Max loss equals the premium. Better when [implied volatility](/wiki/economics/defi/options/implied-volatility) is low (options are cheap to buy).
...
The [option Greeks](/wiki/economics/defi/options/option-greeks) help calibrate strike choice. Delta approximates the probability that the short strike expires in-the-money; theta gives the daily time decay working for or against the position.
