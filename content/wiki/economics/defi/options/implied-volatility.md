...
IV is not a single number -- it varies by [strike price](/wiki/economics/defi/options/strike-price) and expiration. Plotting IV across strikes and expiries produces the *volatility surface*.

Two commonly observed patterns:

- **Volatility skew** -- [out-of-the-money](/wiki/economics/defi/options/strike-price) (OTM) puts tend to have higher IV than at-the-money (ATM) options, reflecting demand for downside protection. In crypto markets this skew can be pronounced during drawdowns.
...
IV interacts directly with the [option greeks](/wiki/economics/defi/options/option-greeks):
