...
Undefined-risk positions -- selling a naked [call](/wiki/economics/defi/options/call-option), providing unbounded liquidity, writing uncollateralized contracts -- can produce losses that exceed the original capital. Risk-defined strategies cap that exposure, which makes them:
...
A [vertical spread](/wiki/economics/defi/options/vertical-spread) combines a long and a short option at different [strike prices](/wiki/economics/defi/options/strike-price) with the same expiry. The maximum loss is the net premium paid (for debit spreads) or the width of the strikes minus the premium received (for credit spreads).
...
In traditional markets, risk definition depends on the broker holding sufficient margin and the clearinghouse guaranteeing settlement. In DeFi, the [smart contract](/wiki/economics/defi/smart-contract) itself is the enforcement mechanism:
...
This model eliminates the counterparty and settlement risks present in traditional options but introduces [smart-contract](/wiki/economics/defi/smart-contract) risk -- a bug in the contract can circumvent the intended risk boundaries entirely.

## Trade-Offs

**Capped profit** -- the defining cost of risk definition. A [vertical spread](/wiki/economics/defi/options/vertical-spread) will never capture the full move of the underlying the way a naked long option can.
