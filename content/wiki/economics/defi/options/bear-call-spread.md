...
A bear call spread is a [vertical spread](/wiki/economics/defi/options/vertical-spread) that profits when the underlying asset stays flat or declines. It is constructed by selling a [call option](/wiki/economics/defi/options/call-option) at a lower [strike price](/wiki/economics/defi/options/strike-price) and buying a call at a higher strike, both with the same expiration. The trade produces a net credit -- the premium collected from the sold call exceeds the premium paid for the bought call.

This is a [risk-defined strategy](/wiki/economics/defi/options/risk-defined-strategy) with capped profit and capped loss, making it popular for generating income in neutral-to-bearish conditions.
...
- **High [implied volatility](/wiki/economics/defi/options/implied-volatility)** -- selling spreads is more attractive when IV is elevated, since the credit received is larger.

## Relationship to Other Spreads

The bear call spread is the credit counterpart of the [bear put spread](/wiki/economics/defi/options/bear-put-spread) -- both are bearish [vertical spreads](/wiki/economics/defi/options/vertical-spread), but the bear call is entered for a credit while the bear put is entered for a debit.

Its bullish mirror is the [bull call spread](/wiki/economics/defi/options/bull-call-spread) (debit, bullish). The other credit vertical is the [bull put spread](/wiki/economics/defi/options/bull-put-spread) (credit, bullish).
