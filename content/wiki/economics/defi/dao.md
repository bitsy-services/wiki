...
**Token-based** -- Anyone who holds the governance token can vote. Tokens are freely tradable on [decentralized exchanges](/wiki/economics/defi/dex), making membership permissionless. Voting power scales with token holdings. [Uniswap](/wiki/economics/defi/uniswap) and MakerDAO use this model.
...
- **Nouns DAO** -- One Noun [NFT](/wiki/economics/defi/nft) is auctioned daily, and all proceeds go to the treasury. Noun holders govern spending. The model has been widely forked.
...
**Smart contract vulnerabilities** -- A bug in the governance contract can be catastrophic. The 2016 DAO hack exploited a reentrancy flaw and drained $50 million in [Ether](/wiki/economics/defi/ethereum/), ultimately leading to Ethereum's contentious hard fork.
