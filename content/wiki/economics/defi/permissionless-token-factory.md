...
- **Token launchers** — fair-launch and memecoin factories deploying token + [LP](/wiki/economics/defi/liquidity-pool) in one transaction.
- **Bitsy: Lepton** — a permissionless fixed-supply token factory using `CREATE2` + [EIP](/wiki/economics/defi/ethereum/eip)-1167.
