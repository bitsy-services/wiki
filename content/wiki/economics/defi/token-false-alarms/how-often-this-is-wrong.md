...
**HoneyBadger** (Torres et al., USENIX Security 2019) scanned 151,935 unique bytecodes and found 460 [honeypots](/wiki/economics/fraud/honeypot-token) — a prevalence of 0.30%. Its headline 87.3% precision is 282 true positives against 41 false positives over 323 contracts, and those 323 are the roughly 70% of flagged contracts whose source Etherscan carried. That is a source-availability subsample, not a random one, and verified honeypots are disproportionately likely to be source-verified. Its per-heuristic table also reports several 100% precisions on denominators of 4, 9 and 12.
