...
Services like MoonPay, Transak, and Ramp Network embed fiat-to-crypto conversion directly into [dApps](/wiki/economics/defi/dapp) and wallets. A user clicks "buy crypto," enters a card number, and receives tokens in their wallet without leaving the application. These processors handle the KYC, banking, and compliance on behalf of the integrating application.
...
- **Geographic restrictions** -- many gateways restrict service in jurisdictions with unclear or hostile regulatory environments. See [DeFi US regulatory restrictions](/wiki/economics/defi/defi-us-regulatory-restrictions) for the US-specific landscape.

The regulatory burden on gateways is one reason the [DeFi](/wiki/economics/defi/dex) ecosystem favors stablecoin-denominated trading -- once a user is on-chain, they can interact with protocols without further fiat conversion.
