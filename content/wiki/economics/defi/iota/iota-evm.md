...
IOTA [EVM](/wiki/economics/defi/ethereum#the-ethereum-virtual-machine-evm) is IOTA's fully [Ethereum](/wiki/economics/defi/ethereum/)-compatible smart-contract chain. It is the practical entry point for [DeFi](/wiki/economics/defi/dex) on IOTA: existing [Solidity](/wiki/economics/defi/solidity/) contracts, [ERC-20](/wiki/economics/defi/ethereum/erc-20) tooling, MetaMask, Hardhat, and Foundry all work unmodified, with configuration changes only. It launched on mainnet in 2024 and continues to run as a Layer 2 alongside the [Move](/wiki/economics/defi/iota/iota-rebased) Layer 1 introduced by the [Rebased](/wiki/economics/defi/iota/iota-rebased) upgrade.

## Architecture

IOTA EVM is one chain produced by **IOTA Smart Contracts (ISC)**, the framework that runs sandboxed contract chains and anchors their state to IOTA Layer 1. From a developer's point of view it is an ordinary EVM chain; the ISC layer underneath handles settlement to L1 and asset movement. The native [IOTA token](/wiki/economics/defi/cryptocurrency) is the gas currency, and a bridge moves value between L1 native assets and L2 EVM balances.
