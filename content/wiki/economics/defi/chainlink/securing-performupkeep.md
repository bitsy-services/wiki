...
- **[MEV](/wiki/economics/defi/maximal-extractable-value)-sensitive operations** — if `performData` encodes a price or trade route, an attacker who calls `performUpkeep` with crafted data could extract value.
