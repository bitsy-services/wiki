...
3. **Resolution** -- an [oracle](/wiki/economics/defi/oracle-node) or designated resolver submits the outcome on-chain. The smart contract transitions the market to a settled state.
...
- **Trusted resolver** -- a single designated address (often a multisig or [DAO](/wiki/economics/defi/dao)) can resolve the market at any time. Simpler but introduces centralization risk.
