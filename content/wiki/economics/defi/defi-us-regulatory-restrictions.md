...
The SEC has brought enforcement actions against token issuers, [DEX](/wiki/economics/defi/dex) operators, and lending platforms. The core question in each case is whether the token or service constitutes an unregistered securities offering.
...
[FinCEN](/wiki/economics/regulation/fincen) enforces [anti-money laundering](/wiki/economics/regulation/anti-money-laundering) (AML) and [know-your-customer](/wiki/economics/regulation/know-your-customer) (KYC) rules under the [Bank Secrecy Act](/wiki/economics/regulation/bank-secrecy-act). Any entity that qualifies as a [money services business](/wiki/economics/regulation/money-services-business) (MSB) must register with FinCEN, implement an AML program, and file suspicious activity reports. Whether a DeFi protocol's developers or [DAO](/wiki/economics/defi/dao) constitute an MSB is an open legal question -- FinCEN has signaled that it considers some DeFi activities to fall within its purview. The [regulation](/wiki/economics/regulation) section covers this side of the picture in detail.
...
- **OFAC compliance** -- interacting with sanctioned addresses (knowingly or not) carries civil and potentially criminal liability. [Sanctions are strict-liability and bind every US person](/wiki/economics/regulation/ofac-sanctions), not just regulated institutions.
...
- **Protocol design** -- features like admin keys, fee switches, and governance tokens can influence whether a protocol or its token is classified as a security. [Finalized smart contracts](/wiki/economics/defi/finalized-smart-contract) with no admin controls reduce (but do not eliminate) regulatory surface area.
