...
| `distributeFees(recipient, amount)` | Sends fees to a designated address -- treasury, [DAO](/wiki/economics/defi/dao), staking rewards, etc. |
...
In practice, the authorized distributor is typically a governance contract (a [DAO](/wiki/economics/defi/dao)) or a predefined payout schedule encoded in another smart contract.
...
- **Staking rewards.** Fees distribute to token holders who have [staked](/wiki/economics/defi/staking) governance tokens, aligning protocol revenue with governance participation.
- **Automated payouts.** A [decentralized keeper](/wiki/economics/defi/decentralized-keeper) triggers periodic distribution calls on a schedule, removing the need for manual intervention.
