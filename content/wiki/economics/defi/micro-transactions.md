...
These patterns require transaction costs to be negligible relative to the payment amount. When a single [Ethereum](/wiki/economics/defi/ethereum/) mainnet transaction costs several dollars in gas, sending $0.001 directly on-chain makes no economic sense.

## The Gas Cost Problem

Every transaction on a [blockchain](/wiki/economics/defi/blockchain) competes for block space and must pay a fee to validators. On Ethereum mainnet, even a simple [ERC-20](/wiki/economics/defi/ethereum/erc-20) transfer costs tens of thousands of gas units — a few dollars at ordinary prices, three orders of magnitude or more above the payment it would be carrying, and worse during congestion.
