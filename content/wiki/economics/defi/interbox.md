...
2. Sign an [EIP](/wiki/economics/defi/ethereum/)-712 typed-data message naming the destination account, network, currency, fee and terms. Interbox verifies the signature and derives a short content-addressed identifier from it — an **Inter Box Code**.
...
**Wallets:** MetaMask and other injected [Ethereum](/wiki/economics/defi/ethereum/) wallets. WalletConnect appears in older Interbox material but is not implemented.
