...
ERC-667 was an early proposal to add `transferAndCall` functionality to [ERC-20](/wiki/economics/defi/ethereum/erc-20) tokens on [Ethereum](/wiki/economics/defi/ethereum/). It predates the similar and much more widely known [ERC-677](/wiki/economics/defi/ethereum/erc-677), and the two are frequently confused.
...
ERC-667 never advanced beyond the discussion stage and has no notable token implementations. [ERC-677](/wiki/economics/defi/ethereum/erc-677) -- proposed shortly after -- covered the same ground and gained traction through Chainlink's adoption for the LINK token. The later [ERC-1363](/wiki/economics/defi/ethereum/erc-1363) standard further superseded both by adding `approveAndCall` and a safer magic-value callback pattern.
