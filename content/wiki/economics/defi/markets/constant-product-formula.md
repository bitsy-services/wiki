...
weight: 40
aliases: ["/wiki/economics/defi/constant-product-formula/"]
---

The constant product formula is the pricing rule at the heart of most [AMM](/wiki/economics/defi/markets/amm)-based [decentralized exchanges](/wiki/economics/defi/markets/dex). A [liquidity pool](/wiki/economics/defi/markets/liquidity-pool) holds reserves of two tokens, and their product must remain constant through every trade.

```text
x * y = k
```

where `x` and `y` are the reserve quantities and `k` is the invariant. [Uniswap](/wiki/economics/defi/markets/uniswap) V2, SushiSwap, and most early AMMs use this formula. Slippage and [impermanent loss](/wiki/economics/defi/markets/impermanent-loss) are both consequences of this single constraint rather than separate mechanisms.
...
The fee stays in the pool, slightly increasing `k` after every trade. This is how [LPs](/wiki/economics/defi/markets/liquidity-pool) earn income.
...
The constant product formula forces the pool to rebalance on every trade. When the external price of ETH rises, arbitrageurs buy cheap ETH from the pool until the pool's price matches the market. The pool ends up holding less ETH and more USDC than it started with. An LP who deposited at one price ratio and withdraws at another always ends up worse off than someone who simply held the original tokens. This is [impermanent loss](/wiki/economics/defi/markets/impermanent-loss), and it is a direct consequence of the constant product invariant.
...
| Concentrated liquidity | [Virtual reserves](/wiki/economics/defi/markets/virtual-reserves) in a range | Uniswap V3/V4 | High capital efficiency, active management required |
