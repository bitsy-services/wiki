...
title: "Staking"
weight: 110
aliases: ["/wiki/economics/defi/staking/"]
---

Staking is the act of locking cryptocurrency in a protocol to earn rewards. The term covers two distinct mechanisms: **network staking**, where locked tokens secure a blockchain's consensus, and **DeFi staking**, where tokens are deposited into [smart contracts](/wiki/economics/defi/smart-contract) to earn yield from protocol activity.

Both forms make the same trade: capital is committed and illiquid for a defined period, and the payment is for the service the locked capital performs while it sits there.
...
The incentive is symmetric with the stake: the balance that determines how often a validator is selected is the same balance slashing takes from.

### How it works in practice

1. A validator deposits the required minimum (32 ETH on [Ethereum](/wiki/economics/defi/chains/ethereum/), for example).
...
- **[Liquidity pool](/wiki/economics/defi/markets/liquidity-pool) deposits** — providing assets to an [AMM](/wiki/economics/defi/markets/amm) [DEX](/wiki/economics/defi/markets/dex) earns trading fees and sometimes additional token incentives. This is sometimes called [yield farming](/wiki/economics/defi/markets/yield-farming) when the primary goal is earning governance token rewards.
...
| **Illiquidity** | Unbonding periods run from days to weeks. The position cannot be exited inside one, and the price moves throughout. |
...
| **[Impermanent loss](/wiki/economics/defi/markets/impermanent-loss)** | Applies when staking in AMM liquidity pools. The pool rebalances against you as prices move. |
