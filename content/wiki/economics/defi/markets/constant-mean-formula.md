...
weight: 50
aliases: ["/wiki/economics/defi/constant-mean-formula/"]
---

The constant mean formula is the pricing invariant behind Balancer's weighted pools. Where the [constant product formula](/wiki/economics/defi/markets/constant-product-formula) constrains two-asset pools to a 50/50 split, the constant mean formula generalises to **any number of assets** with **arbitrary weight ratios** -- 80/20, 60/20/20, or any combination that sums to 100%.

This makes it possible to build [liquidity pools](/wiki/economics/defi/markets/liquidity-pool) that behave like self-rebalancing index funds: [LPs](/wiki/economics/defi/markets/liquidity-pool) choose the asset mix they want exposure to, and the [AMM](/wiki/economics/defi/markets/amm) maintains those proportions through trading fees rather than manual rebalancing.
...
In a standard 50/50 [Uniswap](/wiki/economics/defi/markets/uniswap)-style pool, an LP's position rebalances aggressively as prices move -- selling the appreciating token and buying the depreciating one. This is the mechanism behind [impermanent loss](/wiki/economics/defi/markets/impermanent-loss).
...
| Pool weights | [IL](/wiki/economics/defi/markets/impermanent-loss) at 2× price change | Effective liquidity depth |
|---|---|---|
| 50/50 | 5.7% | Balanced |
...
Balancer is the primary [DEX](/wiki/economics/defi/markets/dex) built on the constant mean formula. Its pool types include:
