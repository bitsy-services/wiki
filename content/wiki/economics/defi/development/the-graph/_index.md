...
| **Chains** | Many [EVM](/wiki/economics/defi/chains/ethereum#the-ethereum-virtual-machine-evm) + non-EVM | Expanding; see [supported networks](https://thegraph.com/docs/en/developing/supported-networks/) |
...
[Subgraphs](/wiki/economics/defi/development/the-graph/subgraphs) covers the authoring side -- the anatomy of the manifest, schema, and AssemblyScript mappings that turn contract events into queryable entities. [Querying](/wiki/economics/defi/development/the-graph/querying) covers the consuming side: hitting a deployed subgraph's GraphQL endpoint from any HTTP client, with no SDK required.
