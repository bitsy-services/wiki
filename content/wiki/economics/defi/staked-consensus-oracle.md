...
A staked consensus oracle is a design for decentralized data feeds in which [oracle node](/wiki/economics/defi/oracle-node) operators lock up tokens as collateral and a consensus mechanism among stakers determines the value reported to a [smart contract](/wiki/economics/defi/smart-contract). Operators who report honestly earn rewards; operators who deviate from consensus are slashed -- their [staked](/wiki/economics/defi/staking) collateral is partially or fully seized.
...
Chainlink has been introducing its own staking layer ([Chainlink staking](/wiki/economics/defi/chainlink/automation)), where LINK holders can stake to back data-feed accuracy. This moves the DON model closer to a hybrid of both approaches.
