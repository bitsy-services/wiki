...
In the blockchain world, TEEs underpin [confidential smart contracts](/wiki/economics/defi/sapphire) — most prominently [Oasis Sapphire](/wiki/economics/defi/sapphire), the confidential [EVM](/wiki/economics/defi/ethereum/) — as well as confidential off-chain compute, trusted oracles, and key-management services.
