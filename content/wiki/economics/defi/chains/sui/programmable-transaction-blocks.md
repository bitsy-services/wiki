...
- **Aggregator-friendly.** Routers and [DEX](/wiki/economics/defi/markets/dex) aggregators compose pool calls dynamically per request instead of shipping a new contract for each strategy.
