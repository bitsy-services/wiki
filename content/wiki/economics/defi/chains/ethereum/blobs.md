...
A blob is 128 KiB of data that an [Ethereum](/wiki/economics/defi/chains/ethereum/)
block commits to and then forgets. It rides alongside a transaction rather than
inside it: the [EVM](/wiki/economics/defi/chains/ethereum#the-ethereum-virtual-machine-evm)
cannot read it, no contract can store it, and consensus clients delete it after
about 18 days. EIP-4844, an [Ethereum Improvement Proposal](/wiki/economics/defi/chains/ethereum/eip)
shipped in the Dencun upgrade on 13 March 2024, added them to give
[rollups](/wiki/economics/defi/chains/ethereum#scalability-and-layer-2) somewhere
...
most of 2024 and blobs cleared at that floor, which is how [L2](/wiki/economics/defi/blockchain/micro-transactions#layer-2-rollups)
...
[Arweave](/wiki/economics/defi/chains/arweave), which sells permanence outright.
