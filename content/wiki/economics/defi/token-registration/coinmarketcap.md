...
The schema keys refer to the [token property schema](/wiki/economics/defi/token-registration#the-token-property-schema). A block of optional fields — media coverage, emission schedule, sale dates — carries the note that they "could improve the chances of a free listing", and CoinMarketCap's criteria say complete submissions with evidence "will be prioritized for review".
