...
The original V3 swap router. It exposes a clean Solidity interface (`ISwapRouter`) with four functions: `exactInputSingle`, `exactInput`, `exactOutputSingle`, and `exactOutput`. See the [ISwapRouter guide](/wiki/economics/defi/uniswap/iswap-router) for full details.
...
**Strengths:**
- Supports V2, V3, V4, and [NFT](/wiki/economics/defi/nft) purchases in a single transaction
...
- [ISwapRouter Guide](/wiki/economics/defi/uniswap/iswap-router) — detailed walkthrough of the original V3 router
