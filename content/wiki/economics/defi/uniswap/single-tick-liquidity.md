...
A normal [AMM](/wiki/economics/defi/amm) pool has continuous price impact and unbounded but ever-worsening depth. A single-tick position has the opposite pair: near-zero price impact, and a hard quantity ceiling.
...
- **Tight stable pairs.** [LPs](/wiki/economics/defi/liquidity-pool) cluster in a few ticks around 1:1 because correlated assets never need the rest of the curve.
