...
- **[NFT](/wiki/economics/defi/nft)-wrapped positions.** Because each position is a pure function of two tick snapshots and one stored `feeGrowthInsideLast`, Uniswap's [NonfungiblePositionManager](https://github.com/Uniswap/v3-periphery/blob/main/contracts/NonfungiblePositionManager.sol) can wrap positions in [ERC-721](/wiki/economics/defi/ethereum/erc-721) tokens and transfer them freely. The new owner pokes and is paid correctly.
