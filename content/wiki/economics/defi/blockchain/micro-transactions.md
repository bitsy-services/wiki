...
weight: 70
aliases: ["/wiki/economics/defi/micro-transactions/"]
---

A **micro-transaction** is a payment small enough that traditional payment infrastructure cannot process it economically -- typically fractions of a cent to a few cents. On [blockchains](/wiki/economics/defi/blockchain) like [Ethereum](/wiki/economics/defi/chains/ethereum/), transaction fees often exceed the value being transferred, making naive on-chain micro-transactions impractical. Pay-per-use billing, streaming payments, and machine-to-machine commerce all wait on solving it.
...
These patterns require transaction costs to be negligible relative to the payment amount. When a single [Ethereum](/wiki/economics/defi/chains/ethereum/) mainnet transaction costs several dollars in gas, sending $0.001 directly on-chain makes no economic sense.

## The Gas Cost Problem

Every transaction on a [blockchain](/wiki/economics/defi/blockchain) competes for block space and must pay a fee to validators. On Ethereum mainnet, even a simple [ERC-20](/wiki/economics/defi/chains/ethereum/erc-20) transfer costs tens of thousands of gas units — a few dollars at ordinary prices, three orders of magnitude or more above the payment it would be carrying, and worse during congestion.
