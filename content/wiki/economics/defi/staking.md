...
1. A validator deposits the required minimum (32 ETH on [Ethereum](/wiki/economics/defi/ethereum/), for example).
...
- **[Liquidity pool](/wiki/economics/defi/liquidity-pool) deposits** — providing assets to an [AMM](/wiki/economics/defi/amm) [DEX](/wiki/economics/defi/dex) earns trading fees and sometimes additional token incentives. This is sometimes called [yield farming](/wiki/economics/defi/yield-farming) when the primary goal is earning governance token rewards.
...
| **[Impermanent loss](/wiki/economics/defi/impermanent-loss)** | Applies when staking in AMM liquidity pools. The pool rebalances against you as prices move. |
