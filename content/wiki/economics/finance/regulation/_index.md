...
[Regulation E](/wiki/economics/finance/regulation/regulation-e) points the other way entirely. Where the rest of this section conscripts institutions into law enforcement, Regulation E allocates a private loss between a bank and its own customer after an electronic payment goes wrong — It was drafted in 1978 for errors the consumer plainly did not authorise, and now governs the irrevocable instant transfers of [Zelle](/wiki/economics/finance/payments/zelle) and its equivalents, where the consumer pressed the button themselves.
