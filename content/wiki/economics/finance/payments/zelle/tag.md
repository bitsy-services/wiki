...
The commercial motive is the usual one. Zelle's purpose has always been to keep the payment — and therefore the deposit and the customer relationship — inside the bank's own app rather than a technology company's balance. At the consumer end that fight was largely won by 2020. At the merchant end it was not: a small business taking cards pays one and a half to three and a half percent in [interchange](/wiki/economics/finance/payments#the-rails), and a business taking [Venmo or Cash App](/wiki/economics/finance/payments/zelle/zelle-alternatives#against-the-consumer-apps) has a handle, a profile, and a balance living outside the banking system. The tag is the bank consortium's answer to the handle. Zelle counted roughly seven million small businesses already enrolled when it launched the feature, with business payment volume up threefold over the prior three years.
