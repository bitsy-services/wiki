...
[Cash-backed synthetic options](/wiki/economics/finance/defi/options/cash-backed-synthetic-option) combine several properties that, taken together, distinguish them from both traditional options and existing DeFi derivatives. This page catalogs the novel design claims of the CBSO system -- useful for understanding what makes the architecture distinctive and where it advances the state of the art.
