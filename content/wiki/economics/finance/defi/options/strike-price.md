...
ITM options carry intrinsic value and cost more. OTM options have no intrinsic value -- their premium is entirely time value and [implied volatility](/wiki/economics/finance/defi/options/implied-volatility).
...
- **ATM** options have the highest time value and are most sensitive to [volatility](/wiki/economics/finance/defi/volatility) changes (highest vega -- see [option greeks](/wiki/economics/finance/defi/options/option-greeks)).
...
- **[Volatility](/wiki/economics/finance/defi/volatility) environment** -- in high-vol markets, strikes further from spot become more viable because large moves are more probable.
