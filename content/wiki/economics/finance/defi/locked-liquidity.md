...
- **Burn.** Send the [LP](/wiki/economics/finance/defi/liquidity-pool) token (or V2 LP shares) to a dead address. Irreversible, but crude — it also burns the ability to ever collect fees, and V3/V4 positions are [NFTs](/wiki/economics/finance/defi/nft) carrying accrued fees, so burning throws those away too.
