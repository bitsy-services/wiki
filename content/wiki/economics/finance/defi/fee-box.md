...
| `distributeFees(recipient, amount)` | Sends fees to a designated address -- treasury, [DAO](/wiki/economics/finance/defi/dao), staking rewards, etc. |
...
In practice, the authorized distributor is typically a governance contract (a [DAO](/wiki/economics/finance/defi/dao)) or a predefined payout schedule encoded in another smart contract.
...
- **Automated payouts.** A [decentralized keeper](/wiki/economics/finance/defi/decentralized-keeper) triggers periodic distribution calls on a schedule, removing the need for manual intervention.
...
For the full settlement flow and how the Fee Box fits into the contract architecture, see [CBSO Design](/wiki/economics/finance/defi/options/cash-backed-synthetic-options-design).
