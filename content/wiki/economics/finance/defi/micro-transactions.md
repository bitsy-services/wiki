...
These patterns require transaction costs to be negligible relative to the payment amount. When a single [Ethereum](/wiki/economics/finance/defi/ethereum/) mainnet transaction costs several dollars in gas, sending $0.001 directly on-chain makes no economic sense.
