...
Web3 is a shorthand for the idea of rebuilding internet services on decentralized infrastructure -- primarily [blockchains](/wiki/economics/finance/defi/blockchain) -- so that users own their data and assets rather than renting access from platform companies. The term was coined by Gavin Wood, co-creator of [Ethereum](/wiki/economics/finance/defi/ethereum/).
...
**Ownership** -- [Cryptocurrency](/wiki/economics/finance/defi/cryptocurrency) and tokens give users portable, self-custodied assets. A user's wallet and on-chain history travel with them across applications, rather than being locked inside a single platform's database.
