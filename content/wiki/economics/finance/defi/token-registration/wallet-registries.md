...
| --- | --- | --- | --- | --- |
| [Trust Wallet](/wiki/economics/finance/defi/token-registration/trust-wallet) | pull request to `trustwallet/assets` | 500 TWT or 2.5 BNB per pull request | CoinMarketCap listing, audit, 10,000 holders and 15,000 transactions | human review after the fee is paid |
| [MetaMask](/wiki/economics/finance/defi/token-registration/metamask) | pull request to `MetaMask/contract-metadata` | none | signs of activity, a website citing the address | 310 pull requests open; one outside submission took eight weeks |
| [ethereum-lists](/wiki/economics/finance/defi/token-registration/ethereum-lists) | pull request to `ethereum-lists/tokens` | none | a valid file; sixteen chains only | months between merges |
