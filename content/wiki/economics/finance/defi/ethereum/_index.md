...
Ethereum is a programmable [blockchain](/wiki/economics/finance/defi/blockchain) -- a decentralized computing platform where anyone can deploy [smart contracts](/wiki/economics/finance/defi/smart-contract) and build applications that run without centralized control. Launched in 2015, it was created by Vitalik Buterin and a team of co-founders to extend blockchain beyond simple value transfer. Where Bitcoin is digital money, Ethereum is a digital machine that can execute arbitrary logic.

Ethereum's native [cryptocurrency](/wiki/economics/finance/defi/cryptocurrency) is Ether (ETH). It serves two purposes: it is the unit of account for the network, and it pays for computation (transaction fees, called "gas").
...
Smart contracts are typically written in [Solidity](/wiki/economics/finance/defi/solidity/) and compiled to EVM bytecode. The EVM model has been so widely adopted that many other blockchains (Polygon, Arbitrum, Avalanche, BNB Chain) are "EVM-compatible," meaning they run the same bytecode and support the same tooling.
...
Under PoS, validators lock up ETH as collateral ([staking](/wiki/economics/finance/defi/staking)) and are selected to propose and attest to new blocks. Validators who act honestly earn rewards; those who misbehave have their stake "slashed" (partially confiscated). This economic incentive structure secures the network without the energy cost of mining.
...
- **[Decentralized exchanges](/wiki/economics/finance/defi/dex)** -- [AMMs](/wiki/economics/finance/defi/amm) like [Uniswap](/wiki/economics/finance/defi/uniswap) that use [liquidity pools](/wiki/economics/finance/defi/liquidity-pool) and the [constant product formula](/wiki/economics/finance/defi/constant-product-formula) instead of order books
...
- **[DAOs](/wiki/economics/finance/defi/dao)** -- On-chain governance organizations managing protocol treasuries and parameters
- **[Yield farming](/wiki/economics/finance/defi/yield-farming)** -- Strategies for maximizing returns across multiple DeFi protocols
- **[Oracles](/wiki/economics/finance/defi/oracle-node)** -- Services like Chainlink that bring off-chain data on-chain, enabling smart contracts to react to real-world events
