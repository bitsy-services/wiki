...
With ERC-1363, a token holder can transfer tokens *and* notify the recipient in a single transaction. The standard was formalized as EIP-1363 and has an [OpenZeppelin implementation](https://docs.openzeppelin.com/contracts/5.x/api/token/erc20#ERC1363).
