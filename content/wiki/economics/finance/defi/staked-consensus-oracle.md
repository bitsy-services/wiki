...
A staked consensus oracle is a design for decentralized data feeds in which [oracle node](/wiki/economics/finance/defi/oracle-node) operators lock up tokens as collateral and a consensus mechanism among stakers determines the value reported to a [smart contract](/wiki/economics/finance/defi/smart-contract). Operators who report honestly earn rewards; operators who deviate from consensus are slashed -- their [staked](/wiki/economics/finance/defi/staking) collateral is partially or fully seized.

The core idea borrows from proof-of-stake consensus on [blockchains](/wiki/economics/finance/defi/blockchain): economic skin in the game aligns incentives without requiring a trusted third party.
...
Chainlink has been introducing its own staking layer ([Chainlink staking](/wiki/economics/finance/defi/chainlink/automation)), where LINK holders can stake to back data-feed accuracy. This moves the DON model closer to a hybrid of both approaches.
