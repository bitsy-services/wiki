...
The constant product formula forces the pool to rebalance on every trade. When the external price of ETH rises, arbitrageurs buy cheap ETH from the pool until the pool's price matches the market. The pool ends up holding less ETH and more USDC than it started with. An LP who deposited at one price ratio and withdraws at another always ends up worse off than someone who simply held the original tokens. This is [impermanent loss](/wiki/economics/finance/defi/impermanent-loss), and it is a direct consequence of the constant product invariant.
...
| Concentrated liquidity | [Virtual reserves](/wiki/economics/finance/defi/virtual-reserves) in a range | Uniswap V3/V4 | High capital efficiency, active management required |
