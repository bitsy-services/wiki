...
Reusable patterns, best practices, and how-to guides for [Solidity](https://en.wikipedia.org/wiki/Solidity) -- the language most [smart contracts](/wiki/economics/finance/defi/smart-contract) on [Ethereum](/wiki/economics/finance/defi/ethereum) and other EVM chains are written in. The code on these pages is meant to be copy-pasted, so it is written to be correct rather than short.
