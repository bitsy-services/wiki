...
Enforcement has landed on infrastructure and on the cash-out rather than on kit authors, who sit in jurisdictions where any charge would have to be brought locally. Registrars and ad platforms remove domains and campaigns, reported deposit addresses get flagged when funds reach an exchange with [anti-money laundering](/wiki/economics/regulation/anti-money-laundering) obligations, and prosecutions are brought as wire fraud and money laundering against whoever touched the proceeds at the [cash-out](/wiki/economics/fraud/cashing-out) stage. Victims are then approached a second time by [recovery scams](/wiki/economics/fraud/recovery-scam) offering to reverse a transfer nobody can reverse.
