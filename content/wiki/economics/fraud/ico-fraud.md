...
The **initial DEX offering (IDO)** runs the sale through a launchpad contract on a [decentralized exchange](/wiki/economics/defi/dex), with the raise seeding a [liquidity pool](/wiki/economics/defi/liquidity-pool). Trust moved to whoever controls that liquidity after the sale closes, which is exactly the [rug pull](/wiki/economics/fraud/rug-pull) surface, and made [locked liquidity](/wiki/economics/defi/locked-liquidity) a marketing feature.
