...
On a [blockchain](/wiki/economics/defi/blockchain) the deposits are irreversible, no bank reconciles them, and the redistribution can run in a contract anyone can read and nobody can switch off. It sits in the investment-fraud group of [crypto fraud](/wiki/economics/fraud) beside the [exit scam](/wiki/economics/fraud/exit-scam).
