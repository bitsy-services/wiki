...
The Office of Foreign Assets Control (OFAC) administers US economic sanctions. It is part of Treasury, as [FinCEN](/wiki/economics/regulation/fincen) is, and in practice the same compliance team handles both — but the two regimes are legally distinct.

The [Bank Secrecy Act](/wiki/economics/regulation/bank-secrecy-act) and the [anti-money-laundering](/wiki/economics/regulation/anti-money-laundering) regime built on it require you to *report*. OFAC requires you to *stop*.
