...
The model is a simplification, and it fits cash-generating crime (narcotics, extortion) far better than it fits fraud, corruption, or tax evasion, where the funds may start out inside the banking system and never leave it. But it explains the placement-heavy emphasis of US law: the [Bank Secrecy Act](/wiki/economics/regulation/bank-secrecy-act) is overwhelmingly concerned with the moment cash meets a bank.
...
- **Customer identification** — [know your customer](/wiki/economics/regulation/know-your-customer) at onboarding, and beneficial-ownership identification for entities.
...
- **Reporting** — suspicious activity reports to a financial intelligence unit ([FinCEN](/wiki/economics/regulation/fincen) in the US), plus threshold-based reports that require no suspicion at all.
- **Recordkeeping** — retention of identity and transaction records, and propagation of originator details between institutions under the [Travel Rule](/wiki/economics/regulation/travel-rule).
- **Sanctions screening** — technically a separate regime; in practice run by the same team and the same software. See [OFAC sanctions](/wiki/economics/regulation/ofac-sanctions).
