...
[FinCEN](/wiki/economics/regulation/fincen) enumerates seven capacities at 31 CFR 1010.100(ff):
...
**A full [BSA](/wiki/economics/regulation/bank-secrecy-act) program.** Written policies, a designated compliance officer, ongoing training, independent testing, risk-based [KYC](/wiki/economics/regulation/know-your-customer), transaction monitoring, and [Suspicious Activity Reports](/wiki/economics/regulation/bank-secrecy-act#suspicious-activity-reports) at a $2,000 threshold — lower than the $5,000 that applies to banks. Records retained five years, and the [Travel Rule](/wiki/economics/regulation/travel-rule) applied to qualifying transmittals.
