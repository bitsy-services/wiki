...
- **Path:** `content/wiki/economics/defi/sui/` (sibling to `iota/`, `sapphire/`,
  `ethereum/`).
...
out to every sub-page. Cross-link to [iota](/wiki/economics/defi/iota/) (shared lineage).
...
contrast with Solidity (link [solidity](/wiki/economics/defi/solidity/)). Cross-link to
...
(link [maximal-extractable-value](/wiki/economics/defi/maximal-extractable-value)).
...
[dex](/wiki/economics/defi/dex), [dapp](/wiki/economics/defi/dapp), [staking](/wiki/economics/defi/staking).
