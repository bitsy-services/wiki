...
- **Path:** `content/wiki/economics/defi/sapphire/_index.md`
...
3. **How Confidentiality Works (TEEs)** — Intel SGX enclaves, encrypted runtime
   ...
   [tee](/wiki/economics/defi/tee) stub.
...
- **New stub:** `content/wiki/economics/defi/tee.md` — Trusted Execution Environment
